...
const TABLE_SCHEMAS: Record<Table, Record<string, string>> = {
  customers: {
    id: 'number',
    name: 'string',
    email: 'string',
...
const VALID_COLUMNS: Record<Table, Set<string>> = {
...
const NUMERIC_COLUMNS = new Set(['id', 'price', 'stock', 'quantity', 'total', 'customer_id', 'product_id'])
